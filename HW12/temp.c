...
{
int counter = 0;  
    add_records_sensors(data, counter++, 2021, 1, 16, 13, 32, -4);
    add_records_sensors(data, counter++, 2021, 1, 2, 13, 32, 2);
    add_records_sensors(data, counter++, 2021, 1, 1, 0, 4, 2);
    add_records_sensors(data, counter++, 2021, 2, 1, 0, 3, 5);
    add_records_sensors(data, counter++, 2021, 2, 1, 0, 1, -5);
    add_records_sensors(data, counter++, 2021, 3, 1, 0, 1, 1);
    add_records_sensors(data, counter++, 2021, 3, 1, 0, 1, 2);
    add_records_sensors(data, counter++, 2021, 3, 1, 0, 1, 3);
    add_records_sensors(data, counter++, 2021, 4, 1, 0, 1, 1);
    add_records_sensors(data, counter++, 2021, 4, 1, 0, 1, 2);
    add_records_sensors(data, counter++, 2021, 4, 1, 0, 1, 3);
    add_records_sensors(data, counter++, 2021, 5, 1, 0, 1, 1);
    add_records_sensors(data, counter++, 2021, 5, 1, 0, 1, 2);
    add_records_sensors(data, counter++, 2021, 5, 1, 0, 1, 3);
    add_records_sensors(data, counter++, 2021, 6, 1, 0, 1, 1);
    add_records_sensors(data, counter++, 2021, 6, 1, 0, 1, 2);
    add_records_sensors(data, counter++, 2021, 6, 1, 0, 1, 3);
    add_records_sensors(data, counter++, 2021, 7, 1, 0, 1, 10);
    add_records_sensors(data, counter++, 2021, 7, 1, 0, 1, 3);
    add_records_sensors(data, counter++, 2021, 8, 1, 0, 1, 1);
    add_records_sensors(data, counter++, 2021, 8, 1, 0, 1, 2);
    add_records_sensors(data, counter++, 2021, 8, 1, 0, 1, 3);
    add_records_sensors(data, counter++, 2021, 9, 1, 0, 1, 1);
    add_records_sensors(data, counter++, 2021, 9, 1, 0, 1, 2);
    add_records_sensors(data, counter++, 2021, 9, 1, 0, 1, 3);
    add_records_sensors(data, counter++, 2021, 10, 1, 0, 1, 3);
    return counter;
}
...
void mergeSort_t(struct sensors* data, int l, int r) 
{
    if (l == r)
        return;            
    int mid = (l + r) / 2; 
    ...
    int i = l; 
    int j = mid + 1; 
    struct sensors *tmp = (struct sensors*)malloc(r * sizeof(struct sensors));     
...
void mergeSort_d(struct sensors* data, int l, int r) 
{
    if (l == r)
        return;            
    int mid = (l + r) / 2; 
